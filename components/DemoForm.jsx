...
export default function DemoForm() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await apiService.submitDemo(formData);
  ...
  return (
    <div className="w-full max-w-md mx-auto">
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div>
          <label htmlFor="preferredDate" className="block text-sm font-medium text-white mb-1">
            Preferred Demo Date
          </label>
          <input
            type="date"
        ...
        {success && (
          <div className="p-4 bg-green-900/20 border border-green-500 rounded-lg">
            <p className="text-green-400 text-sm">
              Thank you for your demo request! We will contact you within 24 hours to schedule your demo.
            </p>
          </div>
        )}
