...
import { Check, ArrowRight, Globe, Shield, Zap, Users, BarChart3, Clock, TrendingUp, Monitor, MessageSquare, Smartphone, Eye, AlertTriangle } from "lucide-react";
          ...
          <div className="bg-[#1a2025] rounded-2xl p-8 border border-[#f2f827]/20">
            <div className="aspect-video bg-gradient-to-br from-[#2a2d30] to-[#34383b] rounded-xl flex items-center justify-center">
              <div className="text-center">
                ...
                <p className="text-sm text-[#6b7280]">Garment businesses operating "in the shadows"</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-8">
              <div className="bg-[#1a2025] rounded-xl p-6 border border-[#34383b]">
                ...
                <p className="text-[#a8b0b7]">
                  Garment businesses operate "in the shadows," known only through intermediaries, 
