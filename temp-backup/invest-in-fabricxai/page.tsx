...
import { TrendingUp, Users, Globe, Factory, Target, Clock, TrendingDown, Award, Building2, Network, Rocket, Brain, Shield, Zap } from "lucide-react";
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-8 lg:px-16 text-center">
          <div className="mb-8">
            ...
            <p className="text-xl sm:text-2xl text-[#a8b0b7] max-w-4xl mx-auto mb-6">
              Building the AI-powered "operating system" for the $100B+ Asian garment manufacturing industry
            </p>
