...
import { Check, ArrowRight, Users, MessageSquare, BarChart3, Globe, Clock, TrendingUp, Shield, Zap } from "lucide-react";
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-8">
              ...
              >
                ...
                <p className="text-[#a8b0b7]">
                  Asma reviews the "Buyer Happiness Index" and prepares for strategic relationship-building 
