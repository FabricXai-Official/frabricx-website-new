      ...
      <section className="py-20 px-4 sm:px-8 lg:px-16 bg-gradient-to-b from-[#13191d] to-[#1e2529]">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center mb-16">
            ...
            <div className="bg-[#1a2025] rounded-2xl p-6 border border-[#f2f827]/20">
              <div className="aspect-[3/2] bg-gradient-to-br from-[#2a2d30] to-[#34383b] rounded-xl flex items-center justify-center overflow-hidden">
                <img 
                  src="/dashboards/problem-solutions.png" 
                  alt="Current State - Problems and Solutions Dashboard" 
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="bg-[#1a2025] rounded-2xl p-6 border border-[#f2f827]/20">
              <div className="aspect-[2/1] bg-gradient-to-br from-[#2a2d30] to-[#34383b] rounded-xl flex items-center justify-center overflow-hidden">
                <img 
                  src="/dashboards/products.png" 
                  alt="FabricXAI Solution - Products Dashboard" 
                  className="w-full h-full object-contain rounded-xl"
                />
              </div>
            </div>
      ...
      <section className="py-20 px-4 sm:px-8 lg:px-16 bg-[#13191d]">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="bg-[#1a2025] rounded-2xl p-6 border border-[#f2f827]/20">
            <div className="aspect-[2/1] bg-gradient-to-br from-[#2a2d30] to-[#34383b] rounded-xl flex items-center justify-center overflow-hidden">
              <img 
                src="/dashboards/expansion.png" 
                alt="Asian Garment Manufacturing Hub - Expansion Dashboard" 
